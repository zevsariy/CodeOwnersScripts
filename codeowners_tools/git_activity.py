...
def _build_suggestions(counter: Counter, limit: int, min_commits: int) -> List[CandidateSuggestion]:
    ...
    for identity, commits in counter.most_common():
        ...
        suggestions.append(CandidateSuggestion(identity=identity, commits=commits, share=share))
...
def suggest_owners_for_paths(
    ...
    for raw_target in targets:
        ...
        candidates = _build_suggestions(counts, limit=limit, min_commits=min_commits)
        results.append(
